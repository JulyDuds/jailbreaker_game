document.addEventListener('DOMContentLoaded', () => {
    ...
    { palavra: "descarregar", dica: "Transferir ficheiros da internet" },
    { palavra: "enviar", dica: "Carregar ficheiros para a internet" },
    ...
    { palavra: "computador", dica: "Equipamento de mesa" },
    { palavra: "webcam", dica: "Câmara para vídeos online" },
    { palavra: "fotografia", dica: "Imagem digital" },
    { palavra: "video", dica: "Gravação em movimento" },
    { palavra: "musica", dica: "Ficheiro de áudio digital" },
    { palavra: "pen", dica: "Dispositivo de armazenamento portátil" },
    ...
    { palavra: "toque", dica: "Ecrã sensível ao contacto" },
    ...
    { palavra: "hashtag", dica: "Palavra-chave com #" },
    { palavra: "selfie", dica: "Fotografia de si mesmo" },
    { palavra: "captura", dica: "Imagem do ecrã" },
